  ...
  <div class="row">
    ...
    <div class="col-10 px-0">
      <div class="pt-5 ps-5 pe-5">
        <p class="h2 fw-normal mb-3">Edit Trip <c:if test="${requestScope.message ne null}"><span class="text-danger">${requestScope.message}</span></c:if></p>
        <hr>
      </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-5">
                <input type="text" class="form-control" id="txtDestination" name="txtDestination"
                       placeholder="Enter destination" value="${requestScope.trip.destination}">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-2">
              ...
              <div class="col-5">
                <input type="time" class="form-control" id="txtDepartureTime"
                       name="txtDepartureTime" placeholder="--:-- --" value="${requestScope.trip.departureTime}">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-2">
              ...
              <div class="col-5">
                <input type="text" class="form-control" id="txtDriver" name="txtDriver"
                       placeholder="Enter driver" value="${requestScope.trip.driver}">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-2">
              ...
              <div class="col-5">
                <input type="text" class="form-control" id="txtCarType" name="txtCarType"
                       placeholder="Enter car type" value="${requestScope.trip.carType}">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-2">
              ...
              <div class="col-5">
                <input type="text" class="form-control" id="txtMaximumTickerNumber"
                       name="txtMaximumTickerNumber" placeholder="0" value="${requestScope.trip.maximumOnlineTicketNumber}">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-2">
              ...
              <div class="col-5">
                <input type="text" class="form-control" id="txtDepartureDate"
                       name="txtDepartureDate" placeholder="dd/mm/yyyy" value="<fmt:formatDate type="date" value="${requestScope.trip.departureDate}" pattern="dd/MM/yyyy"/>">
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-7 text-center">
                ...
                <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i>
                  Edit</button>
                <input type="hidden" name="tripId" value="${requestScope.trip.tripId}">
              </div>
            </div>
          </form>
          <!--END CODE HERE-->
